...
mkrahc_c1<- aov(penres ~ var, data = kra_hc_c1)
summary(mkrahc_c1)
TukeyHSD(mkrahc_c1)
mkrahc_c2<- aov(penres ~ var, data = kra_hc_c2)
summary(mkrahc_c2)
TukeyHSD(mkrahc_c2)
mkrahc_c3<- aov(penres ~ var, data = kra_hc_c3)
summary(mkrahc_c3)
TukeyHSD(mkrahc_c3)
...
mprahc_c1<- aov(penres ~ var, data = pra_hc_c1)
summary(mprahc_c1)
TukeyHSD(mprahc_c1)
mprahc_c2<- aov(penres ~ var, data = pra_hc_c2)
summary(mprahc_c2)
TukeyHSD(mprahc_c2)
mprahc_c3<- aov(penres ~ var, data = pra_hc_c3)
summary(mprahc_c3)
TukeyHSD(mprahc_c3)
...
mnpkhc_c1<- aov(penres ~ var, data = npk_hc_c1)
summary(mnpkhc_c1)
TukeyHSD(mnpkhc_c1)
mnpkhc_c2<- aov(penres ~ var, data = npk_hc_c2)
summary(mnpkhc_c2)
TukeyHSD(mnpkhc_c2)
mnpkhc_c3<- aov(penres ~ var, data = npk_hc_c3)
summary(mnpkhc_c3)
TukeyHSD(mnpkhc_c3)
...
yldl <- yld %>% 
  ...
  filter(year %in% c("20c2", "2015", "2020"))
